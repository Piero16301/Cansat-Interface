  ...
  Future<void> toggleReading({required bool value}) async {
    ...
    emit(
      state.copyWith(
        ...
        gyroscopeDataX: value ? [] : state.gyroscopeDataX,
        gyroscopeY: value ? 0 : state.gyroscopeY,
        gyroscopeDataY: value ? [] : state.gyroscopeDataY,
        gyroscopeZ: value ? 0 : state.gyroscopeZ,
        gyroscopeDataZ: value ? [] : state.gyroscopeDataZ,
        accelerationX: value ? 0 : state.accelerationX,
        accelerationDataX: value ? [] : state.accelerationDataX,
        accelerationY: value ? 0 : state.accelerationY,
        accelerationDataY: value ? [] : state.accelerationDataY,
        accelerationZ: value ? 0 : state.accelerationZ,
        accelerationDataZ: value ? [] : state.accelerationDataZ,
        altitude: value ? 0 : state.altitude,
        altitudeData: value ? [] : state.altitudeData,
      ),
    );
  }
